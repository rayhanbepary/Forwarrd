...
import { updateAdminProfile } from '../../store/actions/adminActions';
...
class UpdateAccount extends Component {
    ...
    submitHandler = (event) => {
        ...
        this.props.updateAdminProfile(this.props.admin._id, { name, address })
        if (name !== '' && address !== '') {
            this.setState({
                success: true
            })
...
export default connect(null, { updateAdminProfile })(UpdateAccount);